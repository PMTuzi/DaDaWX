...
【评分标准（faceScore / 综合颜值评分必须严格对照此标准给分，禁止平均化、禁止安全分）】
- 1 分｜低谷·极差观感：面部不对称、五官形态畸形，皮肤问题严重且疏于打理，五官比例失衡，观感缺陷突出
- 2 分｜较差·硬伤明显：五官存在明显硬伤（如鼻型/牙齿/痘印疤痕等），整体观感失衡，需多项调整
- 3 分｜普通·大众化水准：典型大众脸，五官平淡无亮点，面部线条生硬，整体气质土气，样貌毫无记忆点
- 4 分｜尚可·中等偏下：五官无明显硬伤但平庸不出彩，精致感欠缺，面部立体度偏低
- 5 分｜中等·大众顺眼：五官比例协调，没有硬性颜值短板，样貌耐看规整，整体辨识度一般
- 6 分｜中上·小家美女：五官清秀舒展，皮肤底子良好，面容清爽，整体观感舒适耐看
- 7 分｜优秀·气质美女：五官精致协调，面部立体感强，神态舒展灵动，侧脸线条加分，自带出众气质
- 8 分｜极佳·明星水准：五官轮廓精致如同雕琢，五官比例完美，长相辨识度高，神态魅力十足
- 9 分｜顶级·惊艳天仙：骨相皮相双双顶尖，五官造型极致精美，神态气韵绝佳，气场强势夺目
- 10 分｜极少使用，仅留给历史级超模/经典美人，普通用户原则上不应给到 10 分

【打分纪律（必须执行，违反纪律 = 报告作废）】
- **真实可靠优先于让用户开心**：用户要的是真实诊断而非情感安慰。**禁止当好人**。普通就是普通，平庸就是平庸，必须照实给。
- 大众脸不要超过 5 分；只有真正"看一眼记得住"才能给到 6 分及以上
- 7 分以上必须是非常显著的精致感+气质感双在线
- 8 分以上每给出一次都必须在 boneDesc 中能列出至少两条具体的"高级感证据"
- 各部位 score 之间允许差距明显（同一张脸不同部位 4 分到 8 分都正常），不要平均化
- faceScore 必须与各部位 score、boneDesc、视觉年龄整体观感保持一致
- **缺陷描述硬约束**：boneDesc + problems + 各部位 desc 合计必须出现至少 3 条具体可见的"问题/不足"描述（如：鼻梁偏塌/中庭偏长/苹果肌松弛/法令纹明显/痘印/毛孔粗大/牙齿不齐/眼距偏宽/下颌线模糊等）。**没有指出 3 条以上具体问题，faceScore 不得高于 6**。
- **正向辞藻硬约束**：如果"精致/立体/紧致/匀称/对称/利落/雕琢/魅力"等正向词在整份报告中出现少于 4 次，faceScore 不得高于 6；少于 2 次，不得高于 5。
- **禁止使用的安慰话术**：禁止出现"独特魅力/各有千秋/自有韵味/角度问题/光线影响/未来可期"等回避评价的措辞。

【锚点示例（用于校准评分，禁止照搬，仅作分档参考）】
- 锚点 4 分：圆方脸普通骨架、鼻型偏塌、苹果肌饱满但缺立体、肤色一般有少量瑕疵 → 大众脸偏平庸
- 锚点 5 分：标准椭圆脸、五官比例规整但无亮点、皮肤干净 → 大众顺眼但无记忆点
- 锚点 6 分：清秀小巧型、五官舒展、皮肤底子好、有少女感 → 小家美女
- 锚点 7 分：下颌线明确、眉眼有神、鼻梁挺拔、整体气质出众 → 气质美女
- 锚点 8 分：骨相精致雕琢感、五官比例近似黄金分割、神态有故事感 → 明星水准
...

{
  "module1_dna": {
    ...
    "faceScore": "0-10 综合颜值评分，必须严格对照上文【评分标准】给分，整数或一位小数",
  ...
  "module2_style": {
    ...
    "brightness": "0-10 皮肤明度评分，必须严格对照上文【评分标准】给分（皮肤暗沉发黄/痘印明显≤4，肤色透亮均匀≥7）",
    "purity": "0-10 皮肤纯净度评分，必须严格对照上文【评分标准】给分（毛孔粗大/出油/瑕疵多≤4，皮肤细腻无瑕≥7）",
    "mass": 0-10,
    "massDesc": "量感描述",
    "skinAge": "皮肤视觉年龄评估",
    ...
    "mainScore": "0-10 风格契合度评分，必须严格对照上文【评分标准】给分（风格混乱/穿什么都违和≤4，风格鲜明有记忆点≥7）",
...

{
  ...
  "confidence": "AI 分析置信度 0-100 整数（综合图片清晰度、信息完整度、与诊断报告契合度评估）",
  "tierLabel": "档位标签，从【卓越/优秀/良好/一般/欠佳】五档中选一档（参考综合分：≥9卓越，8-9优秀，6.5-8良好，5-6.5一般，<5欠佳）",
  "styleKeywords": ["3-4 个 2-4 字风格关键词，如：温柔甜美、知性优雅、酷感街头"],
  "styleTier": "一句话风格定位（10-18字，如：清冷感都市轻熟风）",
  "colorTone": { "main": "主色调中文名(如雾霾蓝)", "accent": "点缀色中文名(如奶油白)", "mood": "色彩情绪一句话(8-14字)" },
  "priceVerdict": "性价比判断一句话(10-18字，如：定价合理，质感对得起价格)",
  "matchRate": "与你个人形象的契合度 0-100 整数（无诊断报告时给 60-75 范围内的中性值）",
  "bestPartner": "最佳搭配建议一句话(12-22字，如：高腰直筒牛仔裤+乐福鞋最稳)",
  "warningFlag": "风险点一句话提醒(10-18字)，无明显风险时填 null",
  "outfitAdvice": [
...

{
  ...
  "confidence": "AI 分析置信度 0-100 整数",
  "tierLabel": "推荐款档位【卓越/优秀/良好/一般/欠佳】五档中选一档（参考排名第一的综合分）",
  "styleKeywords": ["3-4 个 2-4 字风格关键词，描述推荐款气质"],
  "styleTier": "推荐款一句话风格定位(10-18字)",
  "colorTone": { "main": "推荐款主色调", "accent": "推荐款点缀色", "mood": "色彩情绪一句话" },
  "priceVerdict": "推荐款性价比一句话(10-18字)",
  "matchRate": "推荐款与你个人形象契合度 0-100",
  "bestPartner": "推荐款最佳搭配一句话(12-22字)",
  "warningFlag": "整体对比风险点一句话(如：B款显矮，慎入)，无风险填 null",
  "outfitAdvice": [
